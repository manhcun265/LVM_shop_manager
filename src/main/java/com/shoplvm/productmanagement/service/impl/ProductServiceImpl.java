...
public class ProductServiceImpl implements ProductService {
     ...
     */
    public Page<ProductDetailResponse> searchProducts(String keyword, Long categoryId, int page, int size) {
    ...
    private ProductDetailResponse convertToProductDetailResponse(Product product) {
        return new ProductDetailResponse(product.getId(), product.getName(), product.getPrice(), product.getCategory().getName());
    }
